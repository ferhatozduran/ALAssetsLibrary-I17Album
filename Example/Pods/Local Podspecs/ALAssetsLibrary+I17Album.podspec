...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/ALAssetsLibrary-I17Album"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Ferhat Ozduran" => "ferhatozduran@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/ALAssetsLibrary-I17Album.git", :tag => s.version.to_s }
